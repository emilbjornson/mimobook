%This Matlab script can be used to reproduce Figure 8.1 in the textbook:
...
plot(angleGrid/pi,pow2db(BF(:,2,1)/max(BF(:,2,1))),':r','LineWidth',1.5)
plot(angleGrid/pi,pow2db(BF(:,2,2)/max(BF(:,2,2))),':b','LineWidth',1.5)
plot(angleGrid/pi,pow2db(BF(:,3,1)/max(BF(:,3,1))),'-.r','LineWidth',1.5)
plot(angleGrid/pi,pow2db(BF(:,3,2)/max(BF(:,3,2))),'-.b','LineWidth',1.5)
plot(angleGrid/pi,pow2db(BF(:,4,1)/max(BF(:,4,1))),'--r','LineWidth',1.5)
plot(angleGrid/pi,pow2db(BF(:,4,2)/max(BF(:,4,2))),'--b','LineWidth',1.5)
plot(angleGrid(maxind1(1))/pi,0,'kx','LineWidth',12)
plot(angleGrid(maxind2(1))/pi,0,'x', 'Color', '[0.90 0.7940 0.0250]','LineWidth',12)
plot(angleGrid(maxind1(2))/pi,0,'kx','LineWidth',12)
plot(angleGrid(maxind2(2))/pi,0,'x', 'Color', '[0.90 0.7940 0.0250]','LineWidth',12)
plot(angleGrid(maxind1(3))/pi,0,'kx','LineWidth',12)
plot(angleGrid(maxind2(3))/pi,0,'x', 'Color', '[0.90 0.7940 0.0250]','LineWidth',12)
plot(angleGrid(maxind1(4))/pi,0,'kx','LineWidth',12)
plot(angleGrid(maxind2(4))/pi,0,'x', 'Color', '[0.90 0.7940 0.0250]','LineWidth',12)
ax = gca;
