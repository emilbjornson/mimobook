%This Matlab script can be used to reproduce Figure 8.15(b) in the textbook:
...
for t = 1:length(angleGrid)
    for t2 = 1:length(angleGrid)
        ...
        BF(t,t2) = 1/abs(arrayResponseVector'*NoiseProj*arrayResponseVector);
